...
```{r}
blogs <- readLines("~/Git/capstoneCoursera/en_US/blogs.txt", n = 5000)
...
# Assume the user types in two words.  Let's take that entry and split it just like we did in constructing the 
# trigram datafram.  

trigram.split.function <- function (x){
